...
public class RestRead {
    ...
    public void createFilterBox(){
        ...
        sendRequestButton.setOnAction(actionEvent -> {
            ...
            if(isNumeric(userIdTextfield.getText())){
                try {
                    ...
                    response.setText(RestClient.getGetResponseValue());
        ...
        filterBox.getChildren().addAll(mainTitle, description, description2, description3, userIdLabel, userIdTextfield, alertIdError,sendRequestButton, mainTitle2, response);
