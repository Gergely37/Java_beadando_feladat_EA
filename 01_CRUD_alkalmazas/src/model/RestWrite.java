...
public class RestWrite {
    ...
    public RestWrite(String title, String taskDescription){
        createFilterBox();
    ...
    public void createFilterBox(){
        ...
        sendRequestButton.setOnAction(actionEvent -> {
            ...
            if(statusComboBox.getValue() != null && matcher.matches() && userName != "" && genderComboBox.getValue() != null){
                try {
                    RestClient.POST(userName,genderComboBox.getValue(),userEmail, statusComboBox.getValue());
