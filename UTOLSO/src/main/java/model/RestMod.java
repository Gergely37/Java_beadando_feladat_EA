...
public class RestMod {
    ...
    public RestMod(String title, String taskDescription){
        createFilterBox();
        ...
        sendRequestButton.setOnAction(actionEvent -> {
            ...
            if(statusComboBox.getValue() != null && matcher.matches() && userName != "" && genderComboBox.getValue() != null && isNumeric(userIdTextfield.getText())){
                ...
                try {
                    ...
                    getResponse.setText("A kérés válasza: " + RestClient.getGetResponseValue());
                } catch (IOException e) {
                    throw new RuntimeException(e);
                }

                try {
                    RestClient.PUT(userIdTextfield.getText(), userName,genderComboBox.getValue(),userEmail, statusComboBox.getValue());
                    response.setText("A kérés válasza: " + RestClient.getGetResponseValue());
                } catch (IOException e) {
                    throw new RuntimeException(e);
                }
            }
