        ...
        sendRequestButton.setOnAction(actionEvent -> {
            ...
            if(statusComboBox.getValue() != null && matcher.matches() && userName != "" && genderComboBox.getValue() != null && isNumeric(userIdTextfield.getText())){
                ...
                try {
                    ...
                    getResponse.setText("A kérés válasza: " + RESTc.getGetResponseValue());
                } catch (IOException e) {
                    throw new RuntimeException(e);
                }
                try {
                    RESTc.PUT(userIdTextfield.getText(), userName,genderComboBox.getValue(),userEmail, statusComboBox.getValue());
                    response.setText("A kérés válasza: " + RESTc.getGetResponseValue());
                } catch (IOException e) {
                    throw new RuntimeException(e);
                }
            }
